    ...
    async def start(self):
        ...
        if config.STRING1:
            try:
                ...
                try:
                    await self.one.join_chat("AnglePriyaBots")
                    await self.one.join_chat("AnglePriyaBotSupport")
        ...
        if config.STRING2:
            try:
                ...
                try:
                    await self.two.join_chat("AnglePriyaBots")
                    await self.two.join_chat("AnglePriyaBotSupport")
                except:
                    pass
        ...
        if config.STRING3:
            try:
                ...
                try:
                    await self.three.join_chat("AnglePriyaBots")
                    await self.three.join_chat("AnglePriyaBotSupport")
                except:
                    pass
        ...
        if config.STRING4:
            try:
                ...
                try:
                    await self.four.join_chat("AnglePriyaBots")
                    await self.four.join_chat("AnglePriyaBotSupport")
                except:
                    pass
        ...
        if config.STRING5:
            try:
                ...
                try:
                    await self.five.join_chat("AnglePriyaBots")
                    await self.five.join_chat("AnglePriyaBotSupport")
                except:
                    pass
