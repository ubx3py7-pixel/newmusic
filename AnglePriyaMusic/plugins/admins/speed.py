...
from AnglePriyaMusic.utils import AdminRightsCheck
from AnglePriyaMusic.utils.database import is_active_chat, is_nonadmin_chat
from AnglePriyaMusic.utils.decorators.language import languageCB
from AnglePriyaMusic.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    try:
        await AnglePriya.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
