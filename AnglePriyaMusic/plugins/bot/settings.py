...
from AnglePriyaMusic.utils.decorators.admins import ActualAdminCB
from AnglePriyaMusic.utils.decorators.language import language, languageCB
from AnglePriyaMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from AnglePriyaMusic.utils.inline.start import private_panel
...
async def send_repo(_, message: Message):
    await message.reply_video(
        ...
        caption=(
            ...
            "🧡 ᴄʀᴇᴅɪᴛꜱ : <a href='https://t.me/AnglePriyaBots'>@AnglePriyaBots</a>"
        ),
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("🎵 Music + Management Bot Repo", url="https://github.com/AnglePriya/AnglePriyaMusic")],
                [InlineKeyboardButton("🎧 Only Music Bot Repo", url="https://github.com/NoxxOP/AnglePriyaMusic")]
            ]
        ),
